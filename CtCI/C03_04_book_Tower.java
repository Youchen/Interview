...
public class C03_04_book_Tower {
	private Stack<Integer> disks;
	private int index;
	public C03_04_book_Tower(int i) {
	...
	public void moveTopTo(C03_04_book_Tower t) {
		int top = disks.pop();
		t.add(top);
	}
    ...
    public void moveDisks(int n, C03_04_book_Tower destination, C03_04_book_Tower buffer){
		if (n > 0) {
