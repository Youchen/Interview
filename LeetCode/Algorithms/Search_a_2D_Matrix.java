 ...
 * Round 3
 * Note:
 *      Remember to check the relashionship of
 *          nums[left] ? target
 *          nums[right] ? target
 *      target might equal to nums[left] or nums[right]
 */
public class Solution {
    public boolean searchMatrix(int[][] matrix, int target) {//2015-05-11 10:48:43 - 2015-05-11 11:04:36 (16 min)
