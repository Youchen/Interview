 ...
 * Round 3
 */
public class Solution {//return index
    public boolean search(int[] nums, int target) {//2015-05-11 14:10:55 - 2015-05-11 14:22:16 (12 min)
        ...
        return (nums[left] == target) ? true : (nums[right] == target) ? true : false;
    }
}
